...
from sqlalchemy import DateTime, ForeignKeyConstraint, Integer, Numeric, PrimaryKeyConstraint, SmallInteger, String, Text, MetaData
...
class Orders(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['customerid'], ['customers.customerid'], name='customer_fk'),
        ForeignKeyConstraint(['employeeid'], ['employees.employeeid'], name='employee_fk'),
